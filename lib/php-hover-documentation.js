    ...
    mouseMoveCallback(e) {
        ...
        if (cachedContent) {
            if (cachedContent != 'NONE') {
                this.currentTooltip = atom.tooltips.add(functionNameNode, { title: cachedContent, trigger: 'hover', delay: 0 });
            }
        } else {
            const context = this;
            ...
            fetch(documentationUrl).then((response) => {
                ...
                if (html) {
                    ...
                    context.currentTooltip = atom.tooltips.add(functionNameNode, { title: content, trigger: 'hover', delay: 0 });
                } else {
